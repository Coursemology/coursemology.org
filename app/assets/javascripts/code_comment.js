...
var Comment = (function(){
    ...
    self.makeComment = function(obj){
        ...
        $li
            .append('<img class="small-profile-pic" src="http://graph.facebook.com/'+obj.uid+'/picture" width="32" height="32" />')
    ...
    self.makeTextarea = function($obj){
        ...
        $li.append('<textarea class="annotate-box" />');
        ...
        var $but = $('<input type="button" value="comment" class="button" />').click(function(){
            ...
            if (t == ''){
                ...
                $.post(makelink('code/_comment'), {cid: ecid, comment: t }, function(s){
                    s = JSON.parse(s);
